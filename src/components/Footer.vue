<template>
    <div id="footer">
        <md-bottom-bar md-sync-route>
            <md-bottom-bar-item  v-if="!user" to="/login" exact md-label="התחברות" md-icon="check_circle"></md-bottom-bar-item>
            ...
            <md-bottom-bar-item v-if="user" :disabled="user.email !== 'yair@cohen.com'" to="/reminders" md-label="תזכורות" md-icon="alarm_on"></md-bottom-bar-item>
        </md-bottom-bar>
    </div>
</template>
